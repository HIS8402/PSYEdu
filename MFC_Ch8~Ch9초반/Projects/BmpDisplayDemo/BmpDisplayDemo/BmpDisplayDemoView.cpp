...
void CBmpDisplayDemoView::OnPaint()
{
	...
	//dc.TransparentBlt(20,100,bmpInfo.bmWidth*2,bmpInfo.bmHeight*2,&MemDC,0,0,bmpInfo.bmWidth,bmpInfo.bmHeight,RGB(255,255,255));
	////dc.BitBlt(0,0,bmpInfo.bmWidth,bmpInfo.bmHeight,&MemDC,0,0,SRCCOPY);

	//MemDC.SelectObject(pOldBmp);

	//CString strImagePath=_T("C:\\Users\\DIT-983\\Desktop\\JG.jpg");
	//CImage Image;
	...
	//CImage Image;
	///*HRESULT hResult=*/Image.Load(_T("C:\\Users\\DIT-983\\Desktop\\JG.jpg"));
	//Image.BitBlt(dc.m_hDC,0,0);
