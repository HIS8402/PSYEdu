...
int CCCreateDemoViewView::OnCreate(LPCREATESTRUCT lpCreateStruct)
{
	...
	m_wndChild.Create(TEXT("STATIC"),TEXT("DEMO"),WS_CHILD | WS_VISIBLE | WS_BORDER, CRect(50,50,200,100),GetDesktopWindow(),1234);
	m_wndChild2.Create(ES_MULTILINE | WS_CHILD | WS_VISIBLE | WS_BORDER, CRect(50, 150, 250, 250), this, 1235);
