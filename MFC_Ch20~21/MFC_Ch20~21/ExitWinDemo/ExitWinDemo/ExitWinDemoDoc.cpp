...
// 축소판 그림을 지원합니다.
void CExitWinDemoDoc::OnDrawThumbnail(CDC& dc, LPRECT lprcBounds)
{
...
// 검색 처리기를 지원합니다.
void CExitWinDemoDoc::InitializeSearchContent()
{
...
void CExitWinDemoDoc::SetSearchContent(const CString& value)
{
	if (value.IsEmpty())
	{
