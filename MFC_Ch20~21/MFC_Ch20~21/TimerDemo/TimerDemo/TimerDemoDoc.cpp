...
// 축소판 그림을 지원합니다.
void CTimerDemoDoc::OnDrawThumbnail(CDC& dc, LPRECT lprcBounds)
{
...
// 검색 처리기를 지원합니다.
void CTimerDemoDoc::InitializeSearchContent()
{
...
void CTimerDemoDoc::SetSearchContent(const CString& value)
{
	if (value.IsEmpty())
	{
