...
BEGIN_MESSAGE_MAP(CHelloSdiView, CEditView)
	...
	ON_COMMAND(ID_FILE_PRINT_PREVIEW, &CHelloSdiView::OnFilePrintPreview)
	ON_WM_CONTEXTMENU()
	ON_WM_RBUTTONUP()
END_MESSAGE_MAP()
...
void CHelloSdiView::OnFilePrintPreview()
{
#ifndef SHARED_HANDLERS
...
void CHelloSdiView::OnRButtonUp(UINT /* nFlags */, CPoint point)
{
	ClientToScreen(&point);
	OnContextMenu(this, point);
}

void CHelloSdiView::OnContextMenu(CWnd* /* pWnd */, CPoint point)
{
#ifndef SHARED_HANDLERS
